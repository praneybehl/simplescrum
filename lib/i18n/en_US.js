...
i18n.map('en_US', {
  ...
  error: {
    ...
    403: 'You are not allowed to access that section of the site.<br />If you have reached this message in error please try again.<br />If you are supposed to have access to this section of the site please contact your account administrator.',
  ...
  message: {
    ...
    success: 'The information has been saved!',
    item_saved: 'You have saved the item successfully!'
  },
  ...
  development: {
    ...
    message: 'This section of the site is still under development.  Please check back at another time.'
  },
